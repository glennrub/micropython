BOARD_SECUREBOOT_DIR = boards/pca10090/secureboot

SRC_SECUREBOOT += $(addprefix $(BOARD_SECUREBOOT_DIR)/,\
        secureboot_main.c \
        )
...
INC_SECUREBOOT += -I/opt/gcc-arm-none-eabi-8-2018-q4-major/lib/gcc/arm-none-eabi/8.2.1/include
...
CFLAGS_SECUREBOOT += $(INC) -Wall -Werror -g -ansi -std=c11 -nostdlib $(COPT)
...
$(BUILD)/secureboot.elf:
	$(Q)$(CC) $(LDFLAGS_SECUREBOOT) $(SRC_SECUREBOOT) $(INC_SECUREBOOT) -O0 -ggdb -o $@ $(LIBS_SECUREBOOT)
	$(SIZE) $@
